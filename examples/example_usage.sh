...
print_status "============================="
./maestro vectordb list --mcp-server-uri="http://localhost:$SERVER_PORT"

print_status ""
print_status "Example 2: List with verbose output"
print_status "==================================="
./maestro vectordb list --mcp-server-uri="http://localhost:$SERVER_PORT" --verbose

print_status ""
print_status "Example 3: Using environment variable"
print_status "====================================="
export MAESTRO_MCP_SERVER_URI="http://localhost:$SERVER_PORT"
./maestro vectordb list

print_status ""
print_status "Example 4: Using .env file"
print_status "=========================="
echo "MAESTRO_MCP_SERVER_URI=http://localhost:$SERVER_PORT" > .env
./maestro vectordb list
rm -f .env
...
print_status "======================"
./maestro vectordb list --mcp-server-uri="http://localhost:$SERVER_PORT" --silent

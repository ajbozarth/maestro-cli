...
func TestMain(m *testing.M) {
	...
	os.Setenv("MAESTRO_TEST_MODE", "true")
...
func buildCLI() {
	cmd := exec.Command("go", "build", "-o", "maestro", "./src")
	cmd.Dir = ".."
...
func TestValidateHelp(t *testing.T) {
	cmd := exec.Command("../maestro", "validate", "--help")
	output, err := cmd.Output()
...
func TestValidateNoArgs(t *testing.T) {
	cmd := exec.Command("../maestro", "validate")
	err := cmd.Run()
...
func TestValidateWithNonExistentFile(t *testing.T) {
	cmd := exec.Command("../maestro", "validate", "nonexistent.yaml")
...
func TestValidateWithVerboseFlag(t *testing.T) {
	...
	cmd := exec.Command("../maestro", "validate", "--verbose", tempFile)
	output, err := cmd.CombinedOutput()
...
func TestValidateWithSilentFlag(t *testing.T) {
	...
	cmd := exec.Command("../maestro", "validate", "--silent", tempFile)
	output, err := cmd.CombinedOutput()
...
func TestValidateWithDryRunFlag(t *testing.T) {
	...
	cmd := exec.Command("../maestro", "validate", "--dry-run", tempFile)
	output, err := cmd.CombinedOutput()

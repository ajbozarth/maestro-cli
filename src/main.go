...
func main() {
	...
	var rootCmd = &cobra.Command{
		Use:   "maestro",
		Short: "Maestro CLI tool",
		Long: `Maestro CLI tool for managing vector databases and their resources.
		
A command-line interface for working with Maestro configurations.`,
